...
const addresses = {
    ...
    timerState: new MemState(wram.uint8Read(0x0943), "timerState", "Timer Status"),
    ...
    collectedItemBits: new MemState(wram.dataRead(0xd870, 20), "collectedItemBits", '"Collected Items" Bit Array'),
    ...
    enemiesKilled: new MemState(wram.uint16Read(0x0e50), "enemiesKilled", "Enemies Killed in Current Room"), 
    killsNeeded: new MemState(wram.uint16Read(0x0e52), "killsNeeded", "Kills Needed to Clear Current Room"), 
